            ...
            <BarChart accessibilityLayer data={projectRevenueChartData} layout="vertical">
              ...
              <Bar stackId="a" dataKey="actual" layout="vertical" fill="var(--color-actual)">
                <LabelList
                  ...
                  position="insideLeft"
                  offset={8}
                  className="fill-primary-foreground text-xs dark:fill-black"
                />
                <LabelList
                  dataKey="actual"
                  position="insideRight"
                  offset={8}
                  className="fill-primary-foreground text-xs tabular-nums dark:fill-black"
                />
              </Bar>
              <Bar
                stackId="a"
              ...
              >
                <LabelList
                  ...
                  position="insideRight"
                  offset={8}
                  className="fill-primary-foreground dark:fill-muted-foreground text-xs tabular-nums"
                />
              </Bar>
            </BarChart>
          </ChartContainer>
